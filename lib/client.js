			...
			const items = effectiveMessages.map((m, i) => {
				...
				return (0, react.createElement)("button", {
					...
					onClick: () => {
						...
						jumpToMessage(sessionsService, sessionId, key, (k) => chatNodeOf(fallbackStore.getSnapshot(), k), void 0, controller.signal, m.seq, (phase) => setJumping(phase === "paging")).finally(() => setJumping(false));
					},
