...
const CHAT_RAIL_NS = "chat-rail";
/** 可配置项：「使用官方轮次导航条」（对比模式，默认关=chat-rail 主导隐藏官方）。 */
const Config = z.object({ showOfficialNavigator: z.boolean().default(false) });
...
function apply(ctx, config) {
	...
	ctx.inject(["settings"], (settingsCtx) => {
		settingsCtx.settings.installSection(ctx, CHAT_RAIL_NS, Config, config, {
			setSource: () => {},
			onChange: () => {}
		});
	});
...
//#endregion
export { CHAT_RAIL_NS, Config, apply, name };
